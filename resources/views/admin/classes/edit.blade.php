    ...
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                <h2><i class="bi bi-pencil-square me-2"></i>Edit Class</h2>
            </div>
            ...
            <form action="{{ route('classes.update', $class->class_id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('class_name') is-invalid @enderror" id="class_name" name="class_name" value="{{ old('class_name', $class->class_name) }}" placeholder="e.g., Nursery A" required>
                    @error('class_name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label for="age_range" class="form-label">Age Range *</label>
                    <input type="text" class="form-control @error('age_range') is-invalid @enderror" id="age_range" name="age_range" value="{{ old('age_range', $class->age_range) }}" placeholder="e.g., 3-4 years" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('school_year') is-invalid @enderror" id="school_year" name="school_year" value="{{ old('school_year', $class->school_year) }}" placeholder="e.g., 2024-2025" required>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('teacher_id') is-invalid @enderror" id="teacher_id" name="teacher_id">
                        ...
                        @foreach($teachers as $teacher)
                            <option value="{{ $teacher->teacher_id }}" @if(old('teacher_id', $class->teacher_id) == $teacher->teacher_id) selected @endif>
                                {{ $teacher->full_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-submit btn-lg"><i class="bi bi-check-circle me-2"></i>Update Class</button>
