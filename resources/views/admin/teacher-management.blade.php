    ...
    <div class="container-fluid py-4">
        <div class="management-header">
            <div>
                ...
                <h2 style="color: var(--phthalo-green); font-weight: bold; margin: 0;">Teachers Management</h2>
            </div>
        ...
        <div class="tab-content">
                ...
                @if($teachers->count())
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            <thead><tr><th>#</th><th>Name</th><th>Email</th><th>Contact</th><th>Joined</th><th>Actions</th></tr></thead>
                            <tbody>
            ...
            <div class="tab-pane fade @if(request('archived')) show active @endif" id="archived" role="tabpanel">
                @if($archived && $archived->count())
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            <thead><tr><th>#</th><th>Name</th><th>Email</th><th>Contact</th><th>Archived</th><th>Actions</th></tr></thead>
                            <tbody>
