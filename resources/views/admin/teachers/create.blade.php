...
<head>
    ...
    <style>
        ...
        .class-item { background: #f8f9fa; padding: 0.5rem 0.75rem; border-radius: 0.375rem; display: inline-block; margin-right: 0.5rem; margin-bottom: 0.5rem; }
    </style>
</head>
<body>
    <div class="form-container">
        <div class="form-card">
            <div class="form-header">
                <h2><i class="bi bi-person-plus me-2"></i>Create New Teacher</h2>
            </div>
            ...
            <form action="{{ route('teachers.store') }}" method="POST" id="teacherForm">
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-submit btn-lg"><i class="bi bi-check-circle me-2"></i>Create Teacher</button>
