    ...
    <div class="container-fluid py-4">
        <div class="management-header">
            <div>
                ...
                <h2 style="color: var(--phthalo-green); font-weight: bold; margin: 0;">Users Management</h2>
            </div>
            <a href="{{ route('users.create') }}" class="btn btn-lg" style="background-color: var(--phthalo-green); color: white;">
        ...
        <ul class="nav nav-tabs mb-4" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link @if(!request('archived')) active @endif" id="active-tab" data-bs-toggle="tab" data-bs-target="#active" type="button" role="tab">
                    <i class="bi bi-check-circle me-2"></i>Active Users
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link @if(request('archived')) active @endif" id="archived-tab" data-bs-toggle="tab" data-bs-target="#archived" type="button" role="tab">
                    <i class="bi bi-archive me-2"></i>Archived Users
                </button>
            </li>
        </ul>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(auth()->id() !== $user->id)
                                        <form action="{{ route('users.destroy', $user) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Archive this user?');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr style="opacity: 0.7;">
                                    ...
                                    <td>
                                        <form action="{{ route('users.restore', $user->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Restore this user?');">
                                            @csrf
