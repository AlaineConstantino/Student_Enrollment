            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control @error('role') is-invalid @enderror" id="role" name="role" required>
                        ...
                        <option value="user" @if(old('role') === 'user') selected @endif>Parent/Guardian</option>
                    </select>
                ...
                <div class="d-flex gap-2 mt-4">
                    <button type="submit" class="btn btn-submit btn-lg"><i class="bi bi-check-circle me-2"></i>Create User</button>
